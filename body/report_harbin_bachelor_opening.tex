...
\begin{figure}[htbp]
    \centering
    \subfigure[Picture a title] {\includegraphics[width=.47\textwidth]{magnet-arch-temp.eps}}
	\subfigure[Picture b title] {\includegraphics[width=.47\textwidth]{magnet-design-space-explo.eps}}
    \caption{MAGNet 架构}
    \label{magnet}
\end{figure}
